...
from synergy.common import serializer as ser
...
def getNotificationListener(target, endpoints):
    ...
    return messaging.get_notification_listener(TRANSPORT, target, endpoints, allow_requeue=True, executor="eventlet")
